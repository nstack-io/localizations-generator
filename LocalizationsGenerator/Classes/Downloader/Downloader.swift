...
struct Downloader {
    ...
    static func dataWithDownloaderSettings(_ settings: DownloaderSettings, localization: Localization) throws -> Data? {
        return try Downloader().localizationDataWithLocalization(localization, settings: settings)
    }
    ...
    func localizationDataWithLocalization(_ localization: Localization, settings: DownloaderSettings) throws -> Data? {
